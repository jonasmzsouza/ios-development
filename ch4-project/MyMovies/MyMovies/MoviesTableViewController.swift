...
class MoviesTableViewController: UITableViewController {
    ...
    func loadMovies() {
        ...
        // Creating a Movie fetRequest because we want to search for all the movies in the database.
    ...
    override func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCell.EditingStyle, forRowAt indexPath: IndexPath) {
        ...
        if editingStyle == .delete {
            ...
            // Recuperando o filme daquela célula
            let movie = fetchedResultsController.object(at: indexPath)
...
extension MoviesTableViewController: NSFetchedResultsControllerDelegate {
    ...
    // The method below is called whenever a change is made to a movie. When this happens, we will reload the table, so it reloads all the movies and updates their content.
